...
According to well-tempered metadynamics[@Parrinello:08:PRL], bias potential ($V_{\text{bias}}$) deposited at any time ($t$) along a single collective variable (CV) with respect to CV every iteration ($niter$),
