...
\end{align*}
\begin{align*}
\Biggl\{ \sum_{\ iter \leq niter - 1}^{}\left\lbrack - w \times \frac{\left( CV - CV_{\text{niter}} \right)}{\sigma^{2}}\exp\left\{ - \frac{1}{2}\left( \frac{\left( CV - CV_{\text{niter}} \right)}{\sigma} \right)^{2} \right\} \right\rbrack\ \\
...
$$\left\{ \frac{dV_{\text{bias}}\left( CV_{1},CV_{2},{\ldots CV_{n},t}_{\text{niter}} \right)}{\text{dC}V_{i}} \right\}_{CV_{i,t}} =$$
\begin{align*}
\Biggl\{ \sum_{\ iter \leq niter - 1}^{}\Biggl\lbrack - w \times \frac{\left( CV_{i} - CV_{i,niter} \right)}{\sigma_{i}^{2}}\exp\left\{ - \frac{1}{2}\left( \frac{\left( CV_{i} - CV_{i,\ niter} \right)}{\sigma_{i}} \right)^{2} \right\} \\ 
...
$$\left\{ \frac{dV_{\text{bias}}\left( CV_{1},CV_{2},{\ldots CV_{n},t}_{\text{niter}} \right)}{\text{dC}V_{i}} \right\}_{CV_{i,t}} =$$
\begin{align*}
\Bigg\{ \sum_{\ iter \leq niter}^{}\Biggl\lbrack - w \times \frac{\left( CV_{i} - CV_{i,niter} \right)}{\sigma_{i}^{2}}\exp\left\{ - \frac{1}{2}\left( \frac{\left( CV_{i} - CV_{i,\ niter} \right)}{\sigma_{i}} \right)^{2} \right\} \\
...
$$\left\{ \frac{dV_{\text{bias}}\left( CV_{1},CV_{2},{\ldots CV_{n},t}_{\text{niter}} \right)}{\text{dC}V_{i}} \right\}_{CV_{i,t}} $$
$$= \left\{ \sum_{\ iter \leq niter}^{}\left\lbrack w \times gDerv(CV_{i} - CV_{i,niter},\sigma_{i}) \times \prod_{j \neq i,j = 1..N}^{}{g\left( CV_{i} - CV_{i,niter},\sigma_{i} \right)}\text{\ \ } \right\rbrack\  \right\}_{CV_{i,t}}$$
